...
class NarrateInvestigationProgress:
    ...
    def _fallback_narrative(self, sender: str, event_id: str, state_summary: dict[str, Any]) -> str:
    ...
    async def execute(
        ...
        *,
        ...
        state = self.investigation_store.get(tenant_id, investigation_id)
        ...
        if self.runtime is None:
            return self._fallback_narrative(sender, event_id, state_summary)
